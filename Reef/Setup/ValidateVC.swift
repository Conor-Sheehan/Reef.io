...
class ValidateVC: UIViewController, UITextFieldDelegate {
  ...
  @IBAction func validateID(_ sender: Any) {
    ...
    if let appDelegate = UIApplication.shared.delegate as? AppDelegate {
      ...
      appDelegate.appBrain.validReefID(with: reefID, completion: { isValid in
...
extension ValidateVC {
  ...
  func addKeyboardObservers() {
      ...
      NotificationCenter.default.addObserver(self, selector: #selector(ValidateVC.keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
      NotificationCenter.default.addObserver(self, selector: #selector(ValidateVC.keyboardWillHide), name: UIResponder.keyboardWillHideNotification, object: nil)
  }
