...
class ForgotPasswordVC: UIViewController, UITextFieldDelegate {
  ...
  @IBAction func resetPassword(_ sender: Any) {
    ...
    Auth.auth().sendPasswordReset(withEmail: email) { error in
      ...
      if let error = error as NSError? {
        ...
        self.alertUser(title: "Email Sent Successfully",
                       message: "Reset password link was sent to the email entered above.")
      }
    }
  ...
  func alertUser(title: String, message: String) {
      ...
      let action = UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: { (_: UIAlertAction) ->
        Void in
...
extension ForgotPasswordVC {
  ...
  /// GESTURE RECOGNIZES USER SWIPE DOWN TO DISMISS KEYBOARD
    ...
    func addKeyboardObservers() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ForgotPasswordVC.keyboardWillShow),
                                               name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(ForgotPasswordVC.keyboardWillHide),
